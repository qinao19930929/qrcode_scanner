...
Future<String> scan(String title, String content, String bottom) async {
  var arguments = {"title": title, "content": content, "bottom": bottom};
  return await _channel.invokeMethod('scan', arguments);
}
